...
# 常量定义
const KNOCKBACK_AMOUNT := 300  # 击退力度
...
@onready var calm_down_timer: Timer = $CalmDownTimer             # 攻击冷却计时器
@onready var attack_checker: RayCast2D = $Graphics/AttackChecker # 攻击范围检测射线
